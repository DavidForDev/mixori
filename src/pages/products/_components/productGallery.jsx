...
const ProductGallery = ({ data, className = "" }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-[0_1_auto] flex md:grid md:grid-cols-2 overflow-auto invisible-scroll items-start w-full md:w-fit gap-4">
        {data?.map((el) => (
          <img
            src={el}
            alt="img"
