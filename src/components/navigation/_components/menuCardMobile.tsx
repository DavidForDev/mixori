...
// ================ Types =================== \\
import { MenuCardTypes } from "../../../types/components.type";
...
const MenuCardMobile = ({
  ...
  const subMenuHandle = (href?: string) => {
      ...
      {subMenu && subMenu.length > 0 && (
        ...
        >
          <ul className="flex flex-col gap-10">
            ...
            >
              <CaretArrow className="rotate-90 fill-black/50" />
              <h3 className="text-black/50 text-2xl first-letter:uppercase">
                go back
              </h3>
            </div>
