...
export const SwitchButton = ({
  ...
  return (
    <Link to={to}>
      <button
        {...props}
        className={`${className} first-letter:uppercase flex items-center justify-center h-full ${darkStyle} ${activeStyle} duration-300 transition-all rounded-md border border-solid hover:bg-[#2680EB] hover:border-[#2680EB] bg-transparent text-center p-3 text-sm`}
      >
        {children}
      </button>
    </Link>
